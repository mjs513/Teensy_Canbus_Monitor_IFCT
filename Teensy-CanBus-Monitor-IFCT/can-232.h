...
{
public:
    static void init(INT32U defaultCanSpeed = LW232_DEFAULT_CAN_RATE, const INT8U clock = LW232_DEFAULT_CLOCK_FREQ);
...
private:
    ...
    INT32U lw232CanSpeedSelection = CAN_83K3BPS;
    ...
    INT8U sendMsgBuf(INT32U id, INT8U extflag, INT8U rtrflag, INT8U len, INT8U *buf);
